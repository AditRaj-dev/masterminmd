...
```bash
python "C:\Users\study\.claude\skills\mastermind\scripts\search.py" "<product_type> <industry> <keywords>" --design-system [-p "Project Name"]
```
...
**Example:**
```bash
python "C:\Users\study\.claude\skills\mastermind\scripts\search.py" "beauty spa wellness service" --design-system -p "Serenity Spa"
```
...
```bash
python "C:\Users\study\.claude\skills\mastermind\scripts\search.py" "<query>" --design-system --persist -p "Project Name"
```
...
```bash
python "C:\Users\study\.claude\skills\mastermind\scripts\search.py" "<query>" --design-system --persist -p "Project Name" --page "dashboard"
```
...
```bash
python "C:\Users\study\.claude\skills\mastermind\scripts\search.py" "<keyword>" --domain <domain> [-n <max_results>]
```
...
```bash
python "C:\Users\study\.claude\skills\mastermind\scripts\search.py" "<keyword>" --stack react-native
```
...
```bash
python "C:\Users\study\.claude\skills\mastermind\scripts\search.py" "AI search tool modern minimal" --design-system -p "AI Search"
```
...
python "C:\Users\study\.claude\skills\mastermind\scripts\search.py" "minimalism dark mode" --domain style

# Get UX best practices for search interaction and loading
python "C:\Users\study\.claude\skills\mastermind\scripts\search.py" "search loading animation" --domain ux
```

### Step 4: Stack Guidelines

```bash
python "C:\Users\study\.claude\skills\mastermind\scripts\search.py" "list performance navigation" --stack react-native
```
...
python "C:\Users\study\.claude\skills\mastermind\scripts\search.py" "fintech crypto" --design-system

# Markdown - best for documentation
python "C:\Users\study\.claude\skills\mastermind\scripts\search.py" "fintech crypto" --design-system -f markdown
```
